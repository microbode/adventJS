...
export default function shouldBuyFidelity(times) {
  ...
  const normalAmount = times * ticketPrice;
  let fidelityAmount = fidelityPrice;

  for (let i = 1; i <= times; i++) {
    fidelityAmount = fidelityAmount + ticketPrice * Math.pow(0.75, i);
  }
  return fidelityAmount < normalAmount;
}
